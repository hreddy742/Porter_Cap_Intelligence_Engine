"""add Virginia business entities

Revision ID: c9f5b2d1e4a7
Revises: b8e4a1c0d3f6
...
revision: str = "c9f5b2d1e4a7"
down_revision: str | None = "b8e4a1c0d3f6"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_va_business_entities_normalized_name"),
        "va_business_entities",
        ["normalized_name"],
    )
    op.create_index(
        op.f("ix_va_business_entities_formation_date"),
        "va_business_entities",
        ["formation_date"],
    )
...
def downgrade() -> None:
    op.drop_index(op.f("ix_va_business_entities_formation_date"), table_name="va_business_entities")
    op.drop_index(op.f("ix_va_business_entities_normalized_name"), table_name="va_business_entities")
    op.drop_table("va_business_entities")
