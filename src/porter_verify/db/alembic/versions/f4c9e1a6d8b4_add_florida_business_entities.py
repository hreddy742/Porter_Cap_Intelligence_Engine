"""add Florida business entities

Revision ID: f4c9e1a6d8b4
Revises: e2b8d0f5c7a3
...
revision: str = "f4c9e1a6d8b4"
down_revision: str | None = "e2b8d0f5c7a3"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_fl_business_entities_normalized_name"),
        "fl_business_entities",
        ["normalized_name"],
    )
    op.create_index(
        op.f("ix_fl_business_entities_formation_date"),
        "fl_business_entities",
        ["formation_date"],
    )
...
def downgrade() -> None:
    op.drop_index(op.f("ix_fl_business_entities_formation_date"), table_name="fl_business_entities")
    op.drop_index(
        op.f("ix_fl_business_entities_normalized_name"), table_name="fl_business_entities"
    )
    op.drop_table("fl_business_entities")
