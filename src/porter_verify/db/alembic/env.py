...
Pulls the database URL from application settings (not alembic.ini) and targets
``Base.metadata`` so autogenerate sees every model. Importing the models package
registers all tables on the metadata.
"""
